...
| **`ActionList`** / **`ActionMenu`** | **`ActionListTokens`**, `LayoutTokens`, `PrimerColors` |
| **`FilteredActionList`** / **`SelectPanel`** | `SelectPanelTokens`, `FilteredActionListTokens` (loading/skeleton/select-all), `LayoutTokens`, `PrimerColors`; list body uses **`ActionList`** / **`ActionListLines`** (**`ActionListTokens`** via rows). **`FilteredActionListLoadingKind`** in [`FilteredActionList/types.slint`](FilteredActionList/types.slint). |
