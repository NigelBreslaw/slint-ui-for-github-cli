...
| **`FilteredActionList2`** | `SelectPanelTokens`, `LayoutTokens`, `PrimerColors`; list body uses **`ActionList2`** / **`ActionList2Lines`** (**`ActionList2Tokens`** via rows). No **`FilteredActionListTokens`** in the minimal shell. |
