...
**Imports for views:** [`primer.slint`](primer.slint) — **`AnchoredOverlay`** (optional **`OverlayTokens`** if you theme overlay chrome beside the component), **`Select`**, **`SelectPanel`**, **`SelectOption`**, **`ValidationStatus`**.
