...
description: >-
  ...
  app/src/ui/Primer/, complex controls (hover, pressed, disabled, selected,
...
- **Contributor guide:** [`app/src/ui/Primer/AGENTS.md`](../../../app/src/ui/Primer/AGENTS.md) — token globals, barrel exports, verification commands.
- **Reference implementation:** [`app/src/ui/Primer/Checkbox/checkbox.slint`](../../../app/src/ui/Primer/Checkbox/checkbox.slint) — uses `states [ … ]` on a named sub-element (`check-visuals`) with conditions like `filled-pressed when !root.disabled && root.filled && touch.pressed`.
