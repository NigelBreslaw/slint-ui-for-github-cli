...
description: >-
  Registers SVG icons for the Primer Slint app via app/src/ui/Primer/assets/icons.slint
...
- [`app/src/ui/Primer/AGENTS.md`](../../../app/src/ui/Primer/AGENTS.md) — short summary; this skill is the full procedure.

## Rules

SVGs are **not** scattered as inline `@image-url("../../assets/…")` across views. Slint only bundles images that appear in the source tree; the **single registry** is [`app/src/ui/Primer/assets/icons.slint`](../../../app/src/ui/Primer/assets/icons.slint) (`export global Icons { … }`). Asset files live under [`app/src/ui/Primer/assets/`](../../../app/src/ui/Primer/assets/) (e.g. `16px/`, `24px/`).
...
1. Add the `.svg` under **`app/src/ui/Primer/assets/16px/`** or **`24px/`** (match size folder used elsewhere for that glyph).
